...
public class TicTacToeGame {
    private static final Player player1 = new Player(X,"Dahlia");
    private static final Player player2 = new Player(Mark.O,"MyBabe");
